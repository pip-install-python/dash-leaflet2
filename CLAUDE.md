...
`vendor/` now holds exactly one tarball: `dash_clerk_auth-1.0.3.tar.gz`, which
...
package keeps `requires-python >=3.9`. 1.0.3 is a SECURITY floor: this site renders the
